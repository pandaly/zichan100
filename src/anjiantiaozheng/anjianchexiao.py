...
class AnJianCheXiao(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.driver = webdriver.Chrome()
        cls.driver.implicitly_wait(5)
        #cls.driver.maximize_window()
        cls.driver.get('http://123.57.138.166/platform/#/login')
        print("111")
    ...
    def test_weianguanli(self):
        ...
        for itema in self.caidanlists:
            ...
            i=i+1
        print('点击委案管理菜单')
        ActionChains(self.driver).click(self.caidanlists[0]).perform()
        #print(self.caidanlists[0].get_attribute('outerHTML'))


    def test_anjiantiaozheng(self):
        self.anjiantiaozhengli=self.driver.find_elements_by_css_selector('li[class ="el-submenu is-opened"] > ul a:nth-child(6)>li')
        ActionChains(self.driver).click(self.anjiantiaozhengli[0]).perform()
        self.anjianchexiaoli=self.driver.find_elements_by_css_selector('ul[class="horizontal-tab-menu"] li:nth-child(3)>a')
        ActionChains(self.driver).click(self.anjianchexiaoli[0]).perform()
    ...
    def test_chaxun_weiangongsi(self):
        ...
        self.yemian = \
        self.driver.find_elements_by_css_selector('ul[class="el-scrollbar__view el-select-dropdown__list"]')[0]
        ...
        for item in items:
            if "阿里" in item.text:
                ...
                self.driver.find_element_by_css_selector(
                    'ul[class="el-scrollbar__view el-select-dropdown__list"]>li:nth-child(' + str(n - 1) + ')').click()
        ...
        '''定位查询按钮'''
        self.chasunbutton = \
        self.driver.find_elements_by_css_selector('button[class="el-button el-button--success el-button--mini"]')[0]
    ...
    def test_xinzeng(self):
        '''定位新增按钮'''
        self.xinzengbutton = \
        self.driver.find_elements_by_css_selector('button[class="el-button el-button--primary el-button--mini"]')[0]
        '''点击新增按钮'''
        ...
        '''定位委案公司列表'''
        self.xinzeng_gongsilists = self.driver.find_elements_by_css_selector(
        ...
        sleep(1)
        '''定位产品类型列表'''
        self.xinzeng_leixinglists = self.driver.find_elements_by_css_selector(
            'ul[class="el-scrollbar__view el-select-dropdown__list"]')
        ...
        '''定位确定按钮'''
        self.quedingbutton = \
        self.driver.find_elements_by_css_selector('button[class="el-button el-button--primary el-button--mini"]')[4]
...
if __name__=='__main__':
    ...
    suite.addTest(AnJianCheXiao('test_denglu'))
    suite.addTest(AnJianCheXiao('test_weianguanli'))
    suite.addTest(AnJianCheXiao('test_anjiantiaozheng'))
    #suite.addTest(AnJianCheXiao('test_AnJianCheXiao'))
    #suite.addTest(AnJianCheXiao('test_chaxun_weiangongsi'))
    #suite.addTest(AnJianCheXiao('test_chaxun_chanpinleixing'))
    #suite.addTest(AnJianCheXiao('test_xinzeng'))
